...
- a Breadcrumb account identifier (UUID)
...
If we make material changes, we will update the "Last updated" date above and notify users in-app before the changes take effect. Continued use of Breadcrumb after a change means you accept the updated policy.
